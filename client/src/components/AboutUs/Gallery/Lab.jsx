...
function Lab()
{
    ...
    const campusImages = [
        "/assets/images/lab1.jpeg",
        "/assets/images/lab2.jpeg",
        "/assets/images/lab3.jpeg",
        "/assets/images/lab4.jpeg",
        "/assets/images/lab13.jpeg",
        "/assets/images/lab14.jpeg",
        "/assets/images/lab15.jpeg",
        "/assets/images/lab16.jpeg",
        "/assets/images/lab17.jpeg",
    ];
                ...
                <div className="container divide py-3">
                        ...
                        <div className="gallery-container">
                            {
                                campusImages.map((img, index) => (
                                    <div className="gallery-card" key={index} onClick={() => openImage(index)} >
                                        ...
                                        <div className="imgoverlay"><span>Lab View {index + 1}</span></div>
                                    </div>
                                ))
                            }
                        </div>
                    ...
                    <div className="sidebar">
                        ...
                        <ul>
                            ...
                            <li> <Link to="/itec_course">ITEC course</Link></li>
                            <li className="active"> <Link to="/labs">Labs</Link></li>
