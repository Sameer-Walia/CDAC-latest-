...
function MarksAdded_ByTeacher()
{
    ...
    useEffect(() =>
    {
        document.title = "Marks added by me"
    }, [])
    ...
    useEffect(() =>
    {
        if (email)
        {
            fetch_marks_added_by_me()
        }
    }, [email])

    async function fetch_marks_added_by_me()
    {
        try
        {
            setloading(true)
            ...
            {
                setstudentsdata_marks(resp.data.marks_addedbyMe)
            }
            else 
            {
...
export default MarksAdded_ByTeacher;