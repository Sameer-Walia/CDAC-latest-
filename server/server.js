...
else
{
    ...
    mongoose.connect('mongodb+srv://sameer:123@cluster0.98unnhy.mongodb.net/cdac?retryWrites=true&w=majority&appName=Cluster0').then(() => console.log('Connected to MongoDB'));
