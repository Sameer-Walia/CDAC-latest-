    ...
    try 
    {
        ...
        if (result) 
        {
            const mailOptions = {
                ...
                html: `Dear ${name}<br/><br/>Thanks for signing up on our website.<br/><br/>Click on the following link to activate your account.<br/><br/><a href='https://cdac-latest.vercel.app/activateaccount?code=${acttoken}'>Activate Account<a/>`
            };
    ...
    try 
    {
        ...
        if (result) 
        {
            const mailOptions = {
                ...
                to: email,
                subject: 'Activation Mail from CDAC',
                html: `Dear ${name}<br/><br/>Thanks for signing up on our website.<br/><br/>Click on the following link to activate your account.<br/><br/><a href='http:///activateaccount?code=${acttoken}'>Activate Account<a/>`
            };
        ...
        else
        {
            ...
            if (updateresult.modifiedCount === 1)
            {
                const mailOptions = {
                    ...
                    to: teacheremail,
                    subject: 'Activation Mail from CDAC',
                    html: `Dear ${user.name}<br/><br/>Thanks for signing up on our website.<br/><br/>Click on the following link to activate your account.<br/><br/><a href='http:///activateaccount?code=${user.token}'>Activate Account<a/>`
                };
            ...
            else
            {
                const mailOptions = {
                    ...
                    to: teacheremail,
                    subject: 'Activation Mail from CDAC',
                    html: `Dear ${user.name}<br/><br/>Thanks for signing up on our website.<br/><br/>Click on the following link to activate your account.<br/><br/><a href='https://cdac-latest.vercel.app/activateaccount?code=${user.token}'>Activate Account<a/>`
                };
