        ...
        else
        {
            ...
            if (result)
            {
                const mailOptions = {
                    ...
                    html: `Dear ${user.name}<br/><br/>Click on the Following Link to Reset your Password :-.<br/><br/><a href='https://cdac-latest.vercel.app/reset_password_by_teacher/${passtoken}'>Reset Password<a/><br/><br/>This Link Is Valid For 15 Minutes Only.<br/><br/>If you did not request for password reset, please ignore this email.`
                };
